...
public class ProductController {
    ...
    // Request Part : It is used to bind the multipart/form-data request to a method
    ...
    // The modified response entity is returned which returns the image of the
    // product
    ...
    public ResponseEntity<List<Product>> searchProduct(@RequestParam String keyword) {
        try {
            List<Product> products = (List<Product>) productService.searchProduct(keyword);
